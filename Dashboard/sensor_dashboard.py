...
class SensorDashboard(tk.Tk):
    ...
    def on_start_client(self):
        ...
        # 1. Bepaal waar we nu zijn (in Dashboard/)
        current_dir = os.path.dirname(os.path.abspath(__file__))
        
        # 2. Ga naar de pythonbleakgui folder in SerenaWebApp
        #    Dit gaat 1 map omhoog (..) en dan SerenaWebApp/pythonbleakgui in.
        target_dir = os.path.abspath(os.path.join(current_dir, "..", "SerenaWebApp", "pythonbleakgui"))
